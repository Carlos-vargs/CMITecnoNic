...
module.exports = {
  content: [
    "./Views/**/*.cshtml", // Si estás usando Razor Pages o MVC con vistas en Razor
    "./Scripts/**/*.js", // Si JavaScript en tu proyecto utiliza clases de Tailwind
    "./Content/**/*.css", // Cualquier archivo CSS que pueda tener clases de utilidad Tailwind
  ],
  theme: {
    extend: {
      fontFamily: {
